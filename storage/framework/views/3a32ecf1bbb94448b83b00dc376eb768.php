...
<?php $component = App\View\Components\CustomerLayout::resolve(['title' => 'Home'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <div class="carousel relative container mx-auto" style="max-width:1600px;">
        <div class="carousel-inner relative overflow-hidden w-full">
            ...
            <input class="carousel-open" type="radio" id="carousel-<?php echo e($key + 1); ?>" name="carousel" aria-hidden="true"
                hidden="" checked="checked">
            <div class="carousel-item absolute opacity-0 " style="height:50vh;">
                <div class="h-full w-full mx-auto flex  pt-6 md:pt-0 md:items-center bg-cover bg-right"
                    style="background-image: url(<?php echo e($slide['picture_path']); ?>)">
                    <div class="container mx-auto">
                        <div class="flex flex-col w-8/12 mx-auto items-center px-6 tracking-wide py-4"
                            style="background-color: rgba(0, 0, 0, 0.8)">
                            <p class="text-white text-2xl my-4"><?php echo e($slide['title']); ?></p>
                            <a class="text-xl inline-block no-underline border-b border-gray-300 text-gray-400 leading-relaxed hover:text-white hover:border-white"
                                href="<?php echo e(route('customer.product')); ?>">view product</a>
                        </div>
                    </div>
                </div>
            </div>
            <label for="carousel-<?php echo e($key); ?>"
                class="prev control-<?php echo e($key + 1); ?> w-10 h-10 ml-2 md:ml-10 absolute cursor-pointer hidden text-3xl font-bold text-black hover:text-white rounded-full bg-white hover:bg-gray-900 leading-tight text-center z-10 inset-y-0 left-0 my-auto">‹</label>
            <label for="carousel-<?php echo e($key + 1 + 1); ?>"
                class="next control-<?php echo e($key + 1); ?> w-10 h-10 mr-2 md:mr-10 absolute cursor-pointer hidden text-3xl font-bold text-black hover:text-white rounded-full bg-white hover:bg-gray-900 leading-tight text-center z-10 inset-y-0 right-0 my-auto">›</label>
            ...
            <ol class="carousel-indicators">
                ...
                <li class="inline-block mr-3">
                    <label id="label-carousel-<?php echo e($slide['id']); ?>" for="carousel-<?php echo e($slide['id']); ?>"
    ...
    <section class="bg-white py-8">
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div class="w-1/2 md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="<?php echo e(route('customer.product.show', $product->id)); ?>">
                    ...
                    <p class="pt-1 text-gray-900"><?php echo e('Rp ' . number_format($product->price, 2, ',', '.')); ?>
...
<?php endif; ?><?php /**PATH /Users/macbook/Documents/Development/toko-elektronik/resources/views/customer/home.blade.php ENDPATH**/ ?>