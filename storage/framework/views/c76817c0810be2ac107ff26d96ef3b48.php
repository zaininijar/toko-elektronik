        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                        <?php echo e('Rp' . number_format($total_amount, 2, ',', '.')); ?>
            ...
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        <?php $__currentLoopData = $last_transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $last_transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold"><?php echo e($last_transaction->user->name); ?></p>
                                        <p class="text-xs text-gray-600 dark:text-gray-400">
                                            <?php echo e($last_transaction->id); ?>#<?php echo e(preg_replace('/\D/', '', $last_transaction->created_at)); ?>
                            ...
                            <td class="px-4 py-3 text-sm">
                                <?php echo e('Rp' . number_format($last_transaction->payment->total_amount, 2, ',', '.')); ?>

                            </td>
                            <td class="px-4 py-3 text-xs">
                                <?php switch($last_transaction->status):
                                case ('SUCCESS'): ?>
                                <span
                                    class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                                    <?php echo e($last_transaction->status); ?>
                            ...
                            <td class="px-4 py-3 text-sm">
                                <?php echo e(date('Y/m/d', strtotime($last_transaction->created_at))); ?>
...
<?php endif; ?>
<?php /**PATH /Users/macbook/Documents/Development/toko-elektronik/resources/views/dashboard.blade.php ENDPATH**/ ?>