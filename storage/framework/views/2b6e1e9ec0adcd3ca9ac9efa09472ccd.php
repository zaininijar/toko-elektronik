...
<?php $component = App\View\Components\CustomerLayout::resolve(['title' => 'Shopping Chart'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
        ...
        <div class="container mx-auto flex flex-col items-center pt-4 pb-12">
            ...
            <div class="mx-auto w-full justify-center px-6 md:flex md:space-x-6 xl:px-0">
                <div class="rounded-lg md:w-2/3">
                    <?php $__currentLoopData = $shopping_charts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $shopping_chart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div id="product" data-id="product-<?php echo e($shopping_chart->product->id); ?>"
                        ...
                        <div class="w-3/12 h-24 overflow-hidden relative rounded-lg ">
                            <img src="<?php echo e(Str::startsWith($shopping_chart->product->picture_path, 'https://') ? $shopping_chart->product->picture_path : asset('storage/' . $shopping_chart->product->picture_path)); ?>"
                                alt="<?php echo e($shopping_chart->product->name); ?>" loading="lazy"
                                class="object-cover object-center" />
                        </div>
                        <div class="sm:ml-4 sm:flex sm:w-full sm:justify-between items-start">
                            <div class="mt-5 sm:mt-0">
                                <h2 class="text-lg font-bold text-gray-900"><?php echo e($shopping_chart->product->name); ?></h2>
                                <p class="mt-1 text-xs text-gray-700"><?php echo e($shopping_chart->product->spesification); ?></p>
                                <p class="mt-1 text-xs text-gray-700">Sisa Stok :
                                    <?php echo e($shopping_chart->product->quantity); ?>
                            ...
                            <div class="flex flex-col justify-start gap-4 items-end">
                                <div class="flex items-center border-gray-100">
                                    ...
                                    <input class="h-8 w-8 border bg-white text-center text-xs outline-none"
                                        type="number" value="<?php echo e($shopping_chart->qty); ?>" min="1" id="qty-perproduct"
                                        max="<?php echo e($shopping_chart->product->qty); ?>" />
                                ...
                                <div class="flex items-center space-x-4">
                                    <p class="font-semibold text-lg">
                                        Rp<?php echo e(number_format($shopping_chart->product->price * $shopping_chart->qty, 2, ',', '.')); ?>

                                    </p>
                                    <input type="hidden" id="price-default"
                                        value="<?php echo e($shopping_chart->product->price); ?>">
                                    <input type="hidden" id="price-total-perproduct"
                                        value="<?php echo e($shopping_chart->product->price * $shopping_chart->qty); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="flex-1 flex items-center ml-4">
                            <svg onclick="alertDelete(event)" data-id="<?php echo e($shopping_chart->id); ?>"
                ...
                <div class=" h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
                    <div class="mb-2 flex justify-between">
                        ...
                        <p id="display-subtotal" class="text-gray-700">
                            Rp<?php echo e(number_format($amount_default['subtotal'], 2, ',', '.')); ?></p>
                    </div>
                    <div class="flex justify-between">
                        <p class="text-gray-700">Shipping</p>
                        <p class="text-gray-700">Rp<?php echo e(number_format($amount_default['shipping_cost'], 2, ',', '.')); ?>
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="">
                            <p id="display-total" class="mb-1 text-lg font-bold">
                                Rp<?php echo e(number_format($amount_default['total'], 2, ',', '.')); ?></p>
                        </div>
                    </div>
                                    ...
                                    <div id="product" data-id="product-<?php echo e($shopping_chart->product->id); ?>"
                                        ...
                                        <div class="overflow-hidden w-16 h-16 bg-gray-50 border-b border-gray-200">
                                            <img class="object-cover object-center w-full h-full hover:grow hover:shadow-md"
                                                src="<?php echo e(Str::startsWith($shopping_chart->product->picture_path, 'https://') ? $shopping_chart->product->picture_path : asset('storage/' . $shopping_chart->product->picture_path)); ?>"
                                                alt="<?php echo e($shopping_chart->product->name); ?>" loading="lazy">
                                        </div>
                                        <input type="hidden" name="products[<?php echo e($key); ?>][id]"
                                            value="<?php echo e($shopping_chart->product->id); ?>">
                                        <div class="flex-grow pl-3">
                                            <h6 class="font-semibold uppercase text-gray-600">
                                                <?php echo e($shopping_chart->product->name); ?></h6>
                                            <div class="flex gap-4">
                                                <div class="flex items-center">
                                                    <input type="number" id="qty-perproduct-form"
                                                        ...
                                                        value="<?php echo e($shopping_chart->qty); ?>" min="1"
                                                        max="<?php echo e($shopping_chart->product->quantity); ?>" />
                                                </div>
                                                <div class="">MAX : <?php echo e($shopping_chart->product->quantity); ?></div>
                                            </div>
                                        </div>
                                        <div>
                                            <span id="price-perproduct-display"
                                                class="font-semibold text-gray-600 text-xl">
                                                <?php echo e('Rp ' . number_format($shopping_chart->product->price, 2, ',', '.')); ?>
                                        ...
                                        <div class="w-full flex mb-3 items-center">
                                            ...
                                            <div class="pl-3">
                                                <span class="font-semibold"
                                                    id="subtotal-amount-display"><?php echo e('Rp ' . number_format($amount_default['subtotal'], 2, ',', '.')); ?></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="border-b border-gray-200 md:border-none text-gray-800 text-xl">
                                        <div class="w-full flex items-center">
                                            ...
                                            <div class="pl-3">
                                                ...
                                                <span class="font-semibold"
                                                    id="total-amount-display"><?php echo e(number_format($amount_default['total'], 2, ',', '.')); ?></span>
                                                <input type="hidden" value=<?php echo e($amount_default['total']); ?>"
                                                    id="total-amount">
                                            </div>
                                        </div>
                                    </div>
...
<?php endif; ?><?php /**PATH /Users/macbook/Documents/Development/toko-elektronik/resources/views/customer/shopping-chart.blade.php ENDPATH**/ ?>