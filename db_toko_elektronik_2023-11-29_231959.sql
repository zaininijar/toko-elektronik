...
--
-- Host: 127.0.0.1    Database: db_toko_elektronik
-- ------------------------------------------------------
...
CREATE TABLE `orders` (
  ...
  `shipped_address` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `shipped_cost` double NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `payments` (
  ...
  `payment_status` enum('PAID','PROCCESS','REJECTED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PROCCESS',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `products` (
  ...
  `spesification` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'text',
...
--
-- Table structure for table `shopping_charts`
--

DROP TABLE IF EXISTS `shopping_charts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `shopping_charts` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `shopping_charts_user_id_foreign` (`user_id`),
  KEY `shopping_charts_product_id_foreign` (`product_id`),
  CONSTRAINT `shopping_charts_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `shopping_charts_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'db_toko_elektronik'
--
...
-- Dump completed on 2023-11-29 23:20:23
