                ...
                <div class="w-full overflow-x-auto">
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            ...
                            <tr class="text-gray-700 dark:text-gray-400" id="orders" data-id="{{ $order->id }}">
                                    ...
                                    <div class="flex items-center text-sm">
                                        <div>
                                            <p class="font-semibold">
                                                {{ $order->id }}#{{ preg_replace('/\D/', '', $order->created_at) }}
                                            </p>
                                        </div>
                                    </div>
                                </td>
                                        ...
                                        <div
                                            ...
                                            <div class="w-3/12">
                                                <div class="w-12 h-12 overflow-hidden relative rounded-full ">
                                                    <img src="{{ $order_product->product->picture_path }}"
                                                        alt="product-image"
                                ...
                                <td class="px-4 py-3 text-xs">
                                    ...
                                    @case('PAID')
                                    <form action="{{ route('order.updatePayment', $order->payment->id) }}"
                                        method="post">
                                        @csrf
                                        @method('PUT')
                                        <button type="submit"
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <svg onclick="alertDelete(event)" data-id="{{ $order->id }}"
