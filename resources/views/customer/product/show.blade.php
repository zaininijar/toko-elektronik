    ...
    <div x-data="{ open: false, openModalShoppingChart: false }">
            ...
            <div class="container px-5 py-24 mx-auto border">
                <div class="md:w-4/5 mx-auto flex flex-wrap">
                    <div onmousemove="zoom(event)" class="md:w-1/2 w-full relative overflow-hidden rounded"
                        style="cursor: zoom-in;aspect-ratio: 1/1; background-position: 50% 50%; background-image: url({{ Str::startsWith($product->picture_path, 'https://') ? $product->picture_path : asset('storage/' . $product->picture_path) }});">
                    ...
                    <div class="md:w-1/2 w-full md:pl-10 md:py-6 mt-6 md:mt-0">
                        ...
                        <h1 class="text-gray-900 text-3xl title-font font-bold mb-1">{{ $product->name }}</h1>
                        <h2>
                        ...
                        <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                            {{ $product->quantity }} Unit Tersedia
                        </div>
                        ...
                        <div class="flex justify-between">
                            <div class="flex gap-2">
                                ...
                                <button @click="openModalShoppingChart = true" data-product-id="{{ $product->id }}"
        ...
        <section class="bg-white py-8">
            <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
                ...
                @foreach ($products as $productRelate)
                <div class="w-1/2 md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                    <a href="{{ route('customer.product.show', $productRelate->id) }}">
                        <div class="w-full overflow-hidden hover:grow hover:shadow-lg relative"
                            ...
                            <div class="bg-black text-white ml-auto px-4 py-2 absolute text-xs md:text-base">
                                {{ $productRelate->spesification }}
                            </div>
                            <img class="object-cover object-center h-full w-full"
                                src="{{ Str::startsWith($productRelate->picture_path, 'https://') ? $productRelate->picture_path : asset('storage/' . $productRelate->picture_path) }}"
                                alt="{{ $productRelate->name }}" loading="lazy">
                        </div>
                        <div class="pt-3 flex items-center justify-between">
                            <p class="">{{ $productRelate->name }}</p>
                        ...
                        <p class="pt-1 text-gray-900">{{ 'Rp ' . number_format($productRelate->price, 2, ',', '.') }}
                        </p>
                    </a>
                </div>
                @endforeach
                                    ...
                                    <div class="w-full flex items-center">
                                        ...
                                        <div class="flex-grow pl-3">
                                            ...
                                            <div class="flex gap-4">
                                                ...
                                                <div class="">MAX : {{ $product->quantity }}</div>
                                            </div>
                                        </div>
                                        <div>
                                        ...
                                        <div class="w-full flex mb-3 items-center">
                                            ...
                                            <div class="pl-3">
                                                <span class="font-semibold"
                                                    id="subtotal-amount-display">{{ 'Rp ' . number_format($product->price, 2, ',', '.') }}</span>
                                            </div>
                                        </div>
                                        <div class="w-full flex items-center">
                                            <div class="flex-grow">
                                    ...
                                    <div class="border-b border-gray-200 md:border-none text-gray-800 text-xl">
                                        <div class="w-full flex items-center">
                                            ...
                                            <div class="pl-3">
                                                ...
                                                <span class="font-semibold"
                                                    id="total-amount-display">{{ number_format($product->price, 2, ',', '.') }}</span>
                                                <input type="hidden" value={{ $product->price }}" id="total-amount">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div style="backdrop-filter: blur(2px) grayscale(90%);" x-show="openModalShoppingChart"
            ...
            <div x-show="openModalShoppingChart" x-transition:enter="transition ease-out duration-150"
                ...
                <div class="w-full bg-white px-5 pb-10 pt-5 text-gray-800">
                    <form id="shopping-chart-form" action="{{ route('customer.create-shopping-chart', $product->id) }}"
                            ...
                            <div class="w-full mx-auto text-gray-800 font-light mb-6 pb-6">
                                <div class="w-full flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <input id="product-price-default" type="hidden" value="{{ $product->price }}">
