                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold">{{ $last_transaction->user->name }}</p>
                                        <p class="text-xs text-gray-600 dark:text-gray-400">
                                            {{ $last_transaction->id }}#{{ preg_replace('/\D/', '', $last_transaction->created_at) }}
                                        </p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-sm">
                                {{ 'Rp' . number_format($last_transaction->payment->total_amount, 2, ',', '.') }}
                            </td>
                            ...
                            <td class="px-4 py-3 text-sm">
                                {{ date('Y/m/d', strtotime($last_transaction->created_at)) }}
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
